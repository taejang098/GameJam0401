...
public class UI_SpeedBtn : UI_UpgradeBtn
{
    ...
    {
        InfoStr = $"시원한 아이스 아메리카노입니다.{System.Environment.NewLine}이동속도가 <color=red>{GameManager.Instance.player.speed} + {GameManager.Instance.upgradeValues[3]}</color>만큼 증가합니다.";
